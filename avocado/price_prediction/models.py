...
class AvocadoOrder(models.Model):
    ...
    medium_bags = models.DecimalField(max_digits=20, decimal_places=5)
    large_bags = models.DecimalField(max_digits=20, decimal_places=5)
    exra_large_bags = models.DecimalField(max_digits=20, decimal_places=5)

    AVOCADO_TYPES = [
        "conventional",  
    ]
    avocado_type = models.CharField(choices=AVOCADO_TYPES)
